...
import Ornament3 from '@assets/svg/ramadhan/Ornament3'
    ...
    return (
      <>
        <div className="absolute top-6 right-6 w-24">
          <Ornament3 className="h-auto w-full" />
        </div>
        <div className="absolute top-6 left-6 w-24 -rotate-90">
          <Ornament3 className="h-auto w-full" />
        </div>
        <div className="absolute bottom-6 right-6 w-24 rotate-90">
          <Ornament3 className="h-auto w-full" />
        </div>
        <div className="absolute bottom-6 left-6 w-24 -rotate-180">
          <Ornament3 className="h-auto w-full" />
        </div>
      </>
    )
