  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'linear-gradient(0deg, rgba(38, 38, 38,1) 5%,  rgba(38, 38, 38, 0)  100%)',
        }}
      >
        <div>
          <h4 className="b-4 font-poppins text-neutral-800">The wedding of</h4>
        ...
        <div className="flex flex-col items-center">
          ...
          <div>
            <ButtonCustom
              href={data?.reminder}
              small
              className="mt-4 bg-neutral-50 text-neutral-800"
            >
              Remind Me
            </ButtonCustom>
          </div>
